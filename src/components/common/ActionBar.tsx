...
export const ActionBar = () => {
    ...
    const actionIcons = [
        { icon: Plus, delay: ICON_DELAY * 0.7, tooltip: "Create" },
        { icon: Search, delay: ICON_DELAY * 0.65, tooltip: "Search" },
        { icon: Pin, delay: ICON_DELAY * 0.6, tooltip: "Pin" },
        { icon: Filter, delay: ICON_DELAY * 0.55, tooltip: "Filter" },
        { icon: Settings2, delay: ICON_DELAY * 0.5, tooltip: "Settings"}
    ];
    ...
    return (
        <div className="absolute left-2 z-40 h-[100px] flex items-center">
            ...
            >
                ...
                {actionIcons.map(({ icon: Icon, delay, tooltip }, index) => (
                        <div
                            key={index}
                            className={`
